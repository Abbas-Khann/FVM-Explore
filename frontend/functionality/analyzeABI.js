export const analyzeABI = async (abi) => {
  ...
  async function filterConstructor() {
    constructors = abi.filter((functions) => functions.type === "constructor");
  }

  async function filterEvents() {
    events = abi.filter((functions) => functions.type === "event");
  }

  async function filterErrors() {
    errors = abi.filter((functions) => functions.type === "error");
  }
};
